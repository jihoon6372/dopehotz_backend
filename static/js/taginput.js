...
;(function() {
  var Tags = (function() {
    ...
    // HTML wrapper
    html = '<input class="hashtag_input"></input>';
    ...
    function bindEventKey(wrap, originInput, index) {
      ...
      handlerKey[index] = function(evt) {
        if(evt.target.tagName === 'INPUT' && evt.target.className === 'hashtag_input') {
    ...
    // Destroy
    function destroy() {
      var tagsContainer = qsa('.tags_container');
